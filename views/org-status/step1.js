...
export async function Step1({ state, client, goTo, html, render, root }) {
  ...
  async function lookupTotem() {
    ...
    try {
      ...
      select({ org: match.org, code: String(match.cod), provincia: "" });
    } catch (e) {
  ...
  function view() {
    ...
    return html`
      ...
      <div class="box">
        ...
        <div
          class="menu"
          style="max-height:360px;overflow:auto;border:1px solid #ddd;border-radius:6px"
        >
          <ul class="menu-list">
              ...
              it => html`
                <li>
                  ...
                  >
                    ...
                    ${it.code ? html`<span class="tag ml-2">${it.code}</span>` : ""}
                    ${it.provincia
