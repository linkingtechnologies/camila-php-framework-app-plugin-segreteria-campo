// app-stock-manager.js — Movimentazioni Consumabili
...
async function mount() {
  try {
    const { StockManager } = await import(`./views/stock-manager/index.js?v=${VERSION}`);
    render(await StockManager({ state, client, html, render, root }), root);
  } catch (e) {
