// app-resource-board.js — Gestione Operativa Risorse
...
async function mount() {
  try {
    const { GOR } = await import(`./views/resource-board/index.js?v=${VERSION}`);
    render(await GOR({ state, client, html, render, root }), root);
  } catch (e) {
